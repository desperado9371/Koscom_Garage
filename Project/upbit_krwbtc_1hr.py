...
prev = pd.read_csv('/home/garage/workspace/price_update_crontab/upbit_krwbtc_1hr.csv',index_col=False)
#prev = pd.read_csv('upbit_krwbtc_1hr.csv',index_col=False)
...
#next_df.to_csv('test.csv',index=False)
