...
def FetDtPrc(market='upbit',srt_date='0',end_date='99999999', srt_time = '00', end_time='24'):
    print("market: "+market)
    ...
    try:
        if market == 'upbit':
            query = 'SELECT base_dt,base_time, open_price,close_price,high_price,low_price,volumn FROM history_hr_prc_upbit WHERE base_dt >= %s and base_dt <= %s and base_time >= %s and base_time <=%s'
...
#     print("start")
#     FetDtPrc('upbit','20200101','20200101','00','05')
